...
jQuery(document).ready(function() {
    jQuery("#blogs-main-colour").wpColorPicker({
        palettes: ['#166A9A', '#002145', '#2F5D7C', '#5E869F', '#98B2C3', '#C3D0DB']
    });
        
    jQuery("#blogs-gradient-colour").wpColorPicker({
        palettes: ['#002145', '#2F5D7C', '#5E869F', '#98B2C3', '#C3D0DB']
    });

    jQuery("#blogs-hover-colour").wpColorPicker({
        palettes: ['#E7F4FC', '#002145', '#2F5D7C', '#5E869F', '#98B2C3', '#C3D0DB']
    });
    
    
    jQuery('#blogs-gradient-colour').after('<a id="lighter-colour" href="#">35% lighter than the Main</a>');
    ...
    jQuery('#lighter-colour').click(function(){
            var a = jQuery('#blogs-main-colour').val();
            
            var r = hexToRgb(a).r;
            var g = hexToRgb(a).g;
            var b = hexToRgb(a).b;
            
            jQuery('#blogs-gradient-colour').wpColorPicker( 'color', Lighthen(r, g, b));
        });
